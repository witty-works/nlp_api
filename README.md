...
```
pipenv install --dev
pipenv run python3.9 -m spacy download en_core_web_lg --no-cache-dir
...
```
pipenv uninstall en_core_web_lg
...
python3.9 -m spacy download en_core_web_lg --no-cache-dir
